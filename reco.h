...
// idle and should be commented out for MC simulations
// modify depending on you analysis requirements
...
//         Hamlet::init();
    ...
    void Reco::begin_run(BelleEvent*, int*) {
        ...
        std::cout << "---- Reco's begin_run function -----" << std::endl;
        eid::init_data();
